...
CREATE TABLE `pesquisa` (
  ...
  `cliente_existente` bit(1) NOT NULL,
  `data_pesquisa` datetime(6) DEFAULT NULL,
  `data_simulacao` datetime(6) DEFAULT NULL,
  `id_cliente` int NOT NULL,
  `id_destino` int NOT NULL,
  `qtd_noites_hotel` int NOT NULL,
  `qtd_passagens` int NOT NULL,
  `simular_hotel` bit(1) NOT NULL,
  `simular_passagem` bit(1) NOT NULL,
  PRIMARY KEY (`id`)
